...
<form class="container py-2" method="get" action="index.php">
    ...
    <div class="row g-2 align-items-center">
        <div class="col-12 col-md-9">
            <input
                ...
                name="q"
                class="form-control"
                placeholder="Rechercher une destination (pays, ville, continent)..."
    ...
    <?php if (!empty($destinations)) { ?>
        <div class="mt-2 small text-muted">
            <?php echo count($destinations); ?> destinations disponibles
        </div>
    <?php } ?>
</form>
...
<div class="voyage-menu d-none d-lg-flex container-fluid py-3 justify-content-center align-items-center gap-3">
  ...
  <div class="voyage-dropdown">
    ...
    <div class="voyage-dropdown-content p-3">
      <div class="personne-row">
        ...
        <div class="counter">
          <button class="btn-counter" type="button">−</button>
  ...
  <div class="voyage-dropdown">
    ...
    <div class="voyage-dropdown-content p-3">
      ...
      <input type="date" id="dateDepart" class="form-control form-control-sm">

      <label class="form-label small mt-2">Retour</label>
      <input type="date" id="dateArrivee" class="form-control form-control-sm">
    </div>
  </div>
  ...
  <div class="voyage-search-group">
    ...
    <button class="voyage-reset-icon" type="button">
...
<!-- version mobile -->
<button class="mobile-search-toggle d-lg-none mx-auto d-flex align-items-center justify-content-center gap-3" type="button">
...
<div class="voyage-mobile-drawer" id="voyageDrawer">
  ...
  <div class="drawer-header">
    ...
    <button class="close-drawer" type="button">×</button>
  </div>
  ...
  <div class="container py-4">
    ...
    <div class="voyage-dropdown">
      ...
      <div class="voyage-dropdown-content p-3">
        <label class="form-label small">Départ</label>
        <input type="date" id="dateDepartMobile" class="form-control form-control-sm">

        <label class="form-label small mt-2">Retour</label>
        <input type="date" id="dateArriveeMobile" class="form-control form-control-sm">
      </div>
    </div>

    <!-- actions -->
    <div class="d-flex flex-column gap-3 mt-5">
      <button class="voyage-search-btn w-100 py-4 fs-5" type="button">Rechercher</button>
      <button class="btn btn-outline-secondary mx-auto px-5" type="button">Réinitialiser</button>
    </div>
