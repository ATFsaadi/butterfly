  ...
  <div class="container mt-4 detail-wrap">
    ...
    <div class="card detail-card">
      <div class="card-body detail-body">
        ...
        <?php if ($titreLieu !== ""): ?>
          <p class="text-muted mb-1 detail-sub"><?= htmlspecialchars($titreLieu) ?></p>
        <?php endif; ?>

        <?php if ($continent !== ""): ?>
          <p class="text-muted mb-3 detail-sub"><?= htmlspecialchars($continent) ?></p>
        <?php endif; ?>
        ...
        <div class="detail-list">
          ...
          <div class="detail-row">
            ...
            <span class="detail-value"><?= htmlspecialchars($dateDepart) ?> au <?= htmlspecialchars($dateRetour) ?></span>
          </div>

          <div class="detail-row">
            <span class="detail-label">prix :</span>
            <span class="detail-value"><?= number_format($prix, 2, ",", " ") ?> €</span>
          </div>

          <div class="detail-row">
            <span class="detail-label">places restantes :</span>
            <span class="detail-value"><?= (int)$placesRestantes ?></span>
          </div>
