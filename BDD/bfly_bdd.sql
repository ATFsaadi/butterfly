...
CREATE TABLE voyages_organises (
  ...
  CHECK (nb_places_restantes <= nb_places),
...
CREATE TABLE offres (
  ...
  CHECK (pourcentage_reduction <= 100),
...
TRUNCATE TABLE reservations_voyages;
TRUNCATE TABLE reservations_destinations;
TRUNCATE TABLE offres;
TRUNCATE TABLE voyages_organises;
